...
// VM_SIZES — defaults match hooks/config.ps1 so --no-prompt works without env vars
param systemVmSize = readEnvironmentVariable('SYSTEM_VM_SIZE', 'Standard_D4a_v4')
param workloadVmSize = readEnvironmentVariable('WORKLOAD_VM_SIZE', 'Standard_D32a_v4')
param deepstreamGpuVmSize = readEnvironmentVariable('DEEPSTREAM_GPU_VM_SIZE', 'Standard_NC24ads_A100_v4')
