...
output AI_FOUNDRY_SERVICES_BASE_URL string = createFoundryProject ? aiFoundry.outputs.agentsRuntimeAzureOpenAIBaseUrl : ''
output AI_MODEL_NAME string = aiModelName
