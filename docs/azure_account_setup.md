...
- Select the subscription you are using for this accelerator from the list
    - If you cannot find the subscription, make sure no filters are selected
- Select `Access control (IAM)` and you can see the roles that are assigned to your account for this subscription
    - If you want to see more information about the roles, go to the `Role assignments` tab, search by your account name, and click the role you want to view more information about
